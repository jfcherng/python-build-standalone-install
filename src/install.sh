...
URL_PYTHON_TARBALL_DEFAULT="https://github.com/indygreg/python-build-standalone/releases/download/20240726/cpython-3.12.4+20240726-x86_64-unknown-linux-gnu-install_only_stripped.tar.gz"
